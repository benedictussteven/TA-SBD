...
{   
    ...
    // update user data
    $result = mysqli_query($mysqli, "UPDATE keluar SET kode='$kode',nama='$nama',warna='$warna',ram='$ram',
    kapasitas='$kapasitas',pembeli='$pembeli',tanggal='$tanggal',jumlah='$jumlah' WHERE no=$no");
...
$result = mysqli_query($mysqli, "SELECT * FROM keluar WHERE no=$no");
...
<body>
    <a href="keluar.php">Daftar Penjualan</a>
    <br/><br/>

    <h2>EDIT PENJUALAN</h2>

    <form name="update_stok" method="post" action="edit.keluar.php">
        <table border="0">
            <tr> 
                <td>Kode Barang</td>
            ...
            <tr> 
                <td>Nama Pembeli</td>
                <td><input type="text" name="pembeli" value=<?php echo $pembeli;?>></td>
            </tr>
            <tr> 
